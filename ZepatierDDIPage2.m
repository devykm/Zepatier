...
#import "ZepatierDDIPage2.h"

@implementation ZepatierDDIPage2

- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ZepatierStatisticsDDIPage2;
        
        [[NSBundle mainBundle] loadNibNamed:@"ZepatierDDIPage2" owner:self options:nil];
