...
{
    self.infoPlus = [[NoxafilInfoControl alloc] initWithFrame:CGRectMake(10, 620, 50, 50) textImageName:image imageToPress:@"invanz_r.png"];
    [self addSubview:self.infoPlus];
}

-(void) setPlusInfo:(NSString*)image
{
    self.infoPlus = [[NoxafilInfoControl alloc] initWithFrame:CGRectMake(90, 620, 50, 50) textImageName:image imageToPress:@"invanz_+.png"];
    [self addSubview:self.infoPlus];
}
