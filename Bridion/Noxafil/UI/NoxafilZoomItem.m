...
@implementation NoxafilZoomItem
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.imageShadow setImage:[UIImage imageNamed:@"invanz_page_zoom_back.png"]];
...
{
    self.infoPlus = [[NoxafilInfoControl alloc] initWithFrame:CGRectMake(255, 610, 52, 52) textImageName:image imageToPress:@"invanz_r.png"];
    [self addSubview:self.infoPlus];
}

-(void) setPlusInfo:(NSString*)image
{
    self.infoPlus = [[NoxafilInfoControl alloc] initWithFrame:CGRectMake(170, 610, 52, 52) textImageName:image imageToPress:@"invanz_+.png"];
    [self addSubview:self.infoPlus];
}
...
-(void) open
{
    ...
    _isOpen = YES;
    [self.delegate InvanzZoomItemWillOpen:self];
