...
@implementation ArcStartMeetingMenu
...
-(void) initControl
{
    ...
    UIImageView *backView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arc_play_back.png"]];
    ...
    [btnEnd setImage:[UIImage imageNamed:@"arc_play_stop_btn.png"] forState:UIControlStateNormal];
    [btnEnd setImage:[UIImage imageNamed:@"arc_play_stop_btn_s.png"] forState:UIControlStateHighlighted];
    ...
    [btnStart setImage:[UIImage imageNamed:@"arc_play_play_btn.png"] forState:UIControlStateNormal];
    [btnStart setImage:[UIImage imageNamed:@"arc_play_play_btn_s.png"] forState:UIControlStateHighlighted];
