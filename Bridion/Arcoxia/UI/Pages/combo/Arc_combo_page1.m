...
#import "Arc_combo_page1.h"
#import "InfoControl.h"
#import "UIView-Extensions.h"

@implementation Arc_combo_page1
{
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
	if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictPage19;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [self.imgTitle setImage:[UIImage imageNamed:@"arc_combo_page1_title.png"]];
    ...
    [imgBack setImage:[UIImage imageNamed:@"arc_combo_page1_back2@2x.png"]];
...
-(void)showInfo{
    ...
    if (referenceView == nil || referenceView.alpha == 0.0f){
        referenceView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"arc_combo_page1_info.png"]];
        [referenceView setFrame:CGRectMake(418, 8, 450, 180)];
...
//{
//    return [UIImage imageNamed:@"arc_combo_page1_back.png"];
//}
//
//-(UIImage*) getBackImage2
//{
//    return [UIImage imageNamed:@"arc_combo_page1_back2.png"];
//}
//
//-(NSString*) getInfo1
//{
//    
//    return @"arc_combo_page1_info.png";
//}
//
//-(NSString*) getInfo2
//{
