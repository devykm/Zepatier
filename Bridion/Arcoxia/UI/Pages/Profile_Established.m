...
#import "Profile_Established.h"
#import "InfoControl.h"
#import "UIView-Extensions.h"
@implementation Profile_Established
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictProfile02;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [imgBack setImage:[UIImage imageNamed:@"prof_Established_OA@2x..png"]];
...
-(void)openTreat:(UITapGestureRecognizer *)sender{
    ...
    if(imgTreat == nil || imgTreat.alpha == 0.0){
        ...
        [imgTreat setImage:[UIImage imageNamed:@"prof_Established_OA_treat@2x..png"]];
