...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictPageSafety08;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [fadeTavla setImage:[UIImage imageNamed:@"safety11_tavla.png"]];
...
//    [summary setImage:[UIImage imageNamed:@"safety11_tavla.png"]];
...
-(void)showInfo{
    ...
    if (referenceView == nil || referenceView.alpha == 0.0f){
        referenceView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"safety11_tavla_ref.png"]];
        [referenceView setFrame:CGRectMake(60, 380, 540, 170)];
