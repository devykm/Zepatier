...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictPageSafety04;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [graph setImage:[UIImage imageNamed:@"safety07_slide.png"]];
    ...
    [graphs3 setFrame:CGRectMake(168, 72, graphs3.width, graphs3.height)];
    [graphs3 setWidth:0];
    [self addSubview: graphs3];
//    
    infoButton = [[UIButton alloc]initWithFrame:CGRectMake(50, 440, 50, 50)];
...
-(void)showInfo{
    ...
    if (referenceView == nil || referenceView.alpha == 0.0f){
        referenceView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"safety07_ref.png"]];
        [referenceView setFrame:CGRectMake(20, 410, 500, 100)];
