...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictPageSafety06;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [self.imgTitle setImage:[UIImage imageNamed:@"safety09_tittle.png"]];
    ...
    [graph setImage:[UIImage imageNamed:@"safety09_slide.png"]];
    [graph setContentMode:UIViewContentModeScaleAspectFit];
    [self.container addSubview:graph];
    
    graphs3 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"safety09_graph.png"]];
    //[graphs3 setContentMode:UIViewContentModeTopLeft];
    //[graphs3 setClipsToBounds:YES];
    [graphs3 changeFrameOrigin:CGPointMake(23, 74)];
    ...
    infoButton = [[UIButton alloc]initWithFrame:CGRectMake(50, 445, 50, 50)];
...
-(void)showInfo{
    ...
    if (referenceView == nil || referenceView.alpha == 0.0f){
        referenceView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"safety09_ref.png"]];
