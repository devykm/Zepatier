...
#import "Profile_Early_Stage.h"
#import "InfoControl.h"
#import "UIView-Extensions.h"
@implementation Profile_Early_Stage
{
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictProfile01;
    }
    return self;
}
...
//    [self.imgTitle setImage:[UIImage imageNamed:@"arc_dosage1_title.png"]];
    ...
    [imgBack setImage:[UIImage imageNamed:@"prof_early_stage@2x..png"]];
...
-(void)openTreat:(UITapGestureRecognizer *)sender{
    ...
    if(imgTreat == nil || imgTreat.alpha == 0.0){
        ...
        [imgTreat setImage:[UIImage imageNamed:@"prof_early_stage_treat@2x..png"]];
