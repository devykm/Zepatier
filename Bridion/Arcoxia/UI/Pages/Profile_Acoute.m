...
#import "Profile_Acoute.h"
#import "InfoControl.h"
#import "UIView-Extensions.h"
@implementation Profile_Acoute
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictProfile05;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [imgBack setImage:[UIImage imageNamed:@"prof_acute_gout@2x..png"]];
...
-(void)openTreat:(UITapGestureRecognizer *)sender{
    ...
    if(imgTreat == nil || imgTreat.alpha == 0.0){
        imgTreat = [[UIImageView alloc] initWithFrame:CGRectMake(20, -50, 530, 560)];
        [imgTreat setImage:[UIImage imageNamed:@"prof_acute_gout_treat@2x..png"]];
