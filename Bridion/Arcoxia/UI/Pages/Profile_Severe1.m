...
#import "Profile_Severe1.h"
#import "InfoControl.h"
#import "UIView-Extensions.h"
@implementation Profile_Severe1
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ArcoxiaStatistictProfile03;
    }
    return self;
}
...
-(void) pageDidAppear
{
    ...
    [imgBack setImage:[UIImage imageNamed:@"prof_Severe_and_limiting1@2x..png"]];
...
-(void)openTreat:(UITapGestureRecognizer *)sender{
    ...
    if(imgTreat == nil || imgTreat.alpha == 0.0){
        ...
        [imgTreat setImage:[UIImage imageNamed:@"prof_Severe_and_limiting1_treat@2x..png"]];
