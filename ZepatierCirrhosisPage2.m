...
#import "ZepatierCirrhosisPage2.h"
#import "UIView-Extensions.h"
#import "ExtendUIView.h"
@implementation ZepatierCirrhosisPage2
...
- (id)initWithPageNumber:(int)page size:(CGSize)size
{
    if (self = [super initWithPageNumber:page size:size]) {
        self.statisticId = ZepatierStatisticsCirrhosisPage2;
        
        [[NSBundle mainBundle] loadNibNamed:@"ZepatierCirrhosisPage2" owner:self options:nil];
...
-(void) pageDidAppear
{
    ...
    [UIView animateWithDuration:0.5 delay:0.1 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        [UIView animateWithDuration:0.5 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
            self.title.frame = CGRectMake(36, 55, 671, 107);
